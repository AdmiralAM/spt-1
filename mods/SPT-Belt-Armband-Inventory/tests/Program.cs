...
internal static class Program
{
    ...
    static void Main()
    {
        ...
        Assert(Math.Abs(AccessoryGridPolicy.ExactSplitGridWindowHeight(2) - 190f) < 0.01f, "two separately filtered HeadBand rows reserve chrome for both native grids");
