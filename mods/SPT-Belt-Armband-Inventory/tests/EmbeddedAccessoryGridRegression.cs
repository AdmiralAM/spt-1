...
internal static class EmbeddedAccessoryGridRegression
{
    ...
    internal static void Run()
    {
        ...
        Require(source.Contains("FindResponsiveHost", StringComparison.Ordinal), "must anchor through the active EquipmentTab hierarchy");
        Require(source.Contains("EquipmentTab", StringComparison.Ordinal) && source.Contains("ClosePrefix", StringComparison.Ordinal), "view ownership must follow EquipmentTab Show/Close");
