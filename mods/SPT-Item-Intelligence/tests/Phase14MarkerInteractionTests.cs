...
static class Phase14MarkerInteractionTests
{
    public static int Run()
    {
        ...
        Expect(ItemMarkerPresentation.From(new ItemHoverText("", "", "SAFE TO SELL · surplus 2")).Kind == ItemMarkerKind.SafeToSell, "safe items use the green check marker", ref assertions);
        ...
        Expect(ItemMarkerPresentation.From(new ItemHoverText("ITEM INTELLIGENCE", "a", "NO REQUIREMENT DATA")).Kind == ItemMarkerKind.Information, "neutral data uses the information marker", ref assertions);
