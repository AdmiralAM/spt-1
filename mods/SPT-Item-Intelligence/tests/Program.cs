...
static class Program
{
    ...
    static void Run()
    {
        ...
        int phase17Assertions = Phase17LiveValueTests.Run();
        int phase18Assertions = Phase18TooltipIntelligenceTests.Run();
        int phase19Assertions = Phase19MarkerClippingTests.Run();
        int phase20Assertions = Phase20FirQuestTests.Run();
        int phase21Assertions = Phase21MarkerPolishTests.Run();
        int phase22Assertions = Phase22TooltipGeometryTests.Run();
        int phase23Assertions = Phase23SemanticColorTests.Run();
        int phase24Assertions = Phase24HotPathOptimizationTests.Run();
        ...
        Console.WriteLine("Item Intelligence regression passed through Phase 36: " + phase36Assertions + " raid inventory tooltip assertions; Phase 35=" + phase35Assertions + "; Phase 34=" + phase34Assertions + "; Phase 33=" + phase33Assertions + "; prior phases remain green if execution reaches this line.");
    }
