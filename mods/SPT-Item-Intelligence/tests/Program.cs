...
static class Program
{
    ...
    static void Main()
    {
        ...
        Console.WriteLine("Item Intelligence: " + assertions + " Phase 1, " + phase2Assertions + " Phase 2, " + phase3Assertions + " Phase 3, " + phase4Assertions + " Phase 4, " + phase5Assertions + " Phase 5, " + phase6Assertions + " Phase 6, " + phase7Assertions + " Phase 7, " + phase8Assertions + " Phase 8, " + phase9Assertions + " Phase 9, " + phase10Assertions + " Phase 10, " + phase11Assertions + " Phase 11, " + phase12Assertions + " Phase 12, " + phase13Assertions + " Phase 13, " + phase14Assertions + " Phase 14, " + phase15Assertions + " Phase 15, " + phase16Assertions + " Phase 16, " + phase17Assertions + " Phase 17, " + phase18Assertions + " Phase 18, " + phase19Assertions + " Phase 19, " + phase20Assertions + " Phase 20 and " + phase21Assertions + " Phase 21 assertions passed.");
    }
