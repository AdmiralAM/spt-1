# Admiral Artyom Revival — remaining gates
...
2. **Core import** — authoritative upstream `artem main 1.zip` imports without the legacy DLL and produces the expected runtime layout.
...
5. **Runtime smoke test** — SPT 4.1.4 boots with Admiral Artyom Revival and CommonLib, the Artem trader loads, quests appear, custom items/clothing resolve, and no loader/database errors occur.
...
7. **Economy pass** — trader prices/rewards/stock are reviewed against the project economy without flattening authored Artem progression.
