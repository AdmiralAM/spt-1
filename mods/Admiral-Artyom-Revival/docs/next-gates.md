...
5. **Runtime smoke test** — SPT 4.1.3 boots with Admiral Artyom Revival and CommonLib, the Artem trader loads, quests appear, custom items/clothing resolve, and no loader/database errors occur.
