...
Painter/TGC and WTT Artem are optional content providers for the current consolidation candidate. When present, their persistent quests, offers, item trees, quest unlocks and clothing remain intact but appear under Admiral; the separate Painter and Artem trader tabs are removed after loaded profiles have been migrated and saved. This adds 35 quests and 402 finite offer roots, producing 207 quests without Icebreaker or 217 with Icebreaker. Existing Admiral content is not replaced. Removing either provider simply leaves that provider's optional content absent. See `docs/painter-artem-consolidation-audit.md` for exact source versions, identities, counts and migration behavior.
