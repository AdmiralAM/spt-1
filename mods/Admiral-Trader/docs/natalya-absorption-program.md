...
Natalya also carries 48 custom items, 26 custom zones and four armour presets. None is safe to copy as a prerequisite for a working Admiral installation. Their gameplay role may be represented only with exact SPT 4.1.5-native items and conditions.
