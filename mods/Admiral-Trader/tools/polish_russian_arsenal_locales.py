...
ACCESS_BRIEFS = {
    "1b92e4cf212d895be4f70b2c": ("Найди в рейде один распространённый ключ из списка: ключ от спецтехники, ключ от времянки на заводской зоне Таможни, Неизвестный ключ или ключ от кладовки заправки. Статус «Найдено в рейде» обязателен. Ключ проверяется в инвентаре и не передаётся; аварийный ключ выхода с Завода искать не требуется.", "Маршрут через Завод подтверждён. Теперь ты не зависишь от единственной открытой двери."),
