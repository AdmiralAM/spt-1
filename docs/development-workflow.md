...
3. Open the registered active Issue/PR and affected module documentation.
4. Continue the recorded package and successor until a valid stop boundary.
...
- Keep implementation evidence in the module PR; keep product state in the registry.
...
CI, a commit, or a packaged artifact is evidence, not a reason to stop. When a registered successor is already defined, continue to it without asking the user for a new instruction.
