...
| [Item Valuation MOD SPT](mods/Item-Valuation-MOD-SPT) | `0.1.0`; runtime validation pending | Server-only item value-per-slot to inventory background color mapping | Development source / CI artifacts |
...
Modules still awaiting physical runtime acceptance, including Item Valuation MOD SPT, are distributed only as exact-commit GitHub Actions candidates from their module PR until deliberately promoted.
