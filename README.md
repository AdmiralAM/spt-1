...
| [B&A&HB #2 MOD SPT](mods/SPT-Belt-Armband-Inventory) | **`0.1.0 STABLE` / SPT 4.1.3; compatibility planning in PR #286** | Published full-Belt reserve; planned companion ships only features absent from separately installed Pack 'n' Strap: HeadBand, Dogtag Case and exact B&A-owned protection | **[download stable reserve ZIP](https://github.com/AdmiralAM/spt-1/archive/refs/heads/runtime-belt-armband.zip)** |
