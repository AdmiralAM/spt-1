...
Combined client/server HUD mod for SPT 4.1.x. Current development version: **1.12.0**.
...
- Every HUD pictogram uses a cached dark medallion plate and a category-colored rim for stable contrast without per-frame texture allocation.

## Asset pipeline

- Approved Pictures SPT artwork is stored as normalized transparent source PNGs; the Scav fallback is a distinct masked-bandit silhouette.
...
- `BepInEx/plugins/SPT Tactical HUD v1.12.0` — client HUD and sprite atlas.
